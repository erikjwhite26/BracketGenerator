				...
				{
					{
						...
						new Matchup
						{
							...
							Team2 = new() { Seed = 16, Name = "UC San Diego/Southern" }
						}
					},
					{
						2,
				...
				RegionalMatchups = new()
				{
					...
					},
					{
						...
						new Matchup
						{
							...
							Team2 = new() { Seed = 11, Name = "Columbia/Washington" }
						}
					},
					{
						22,
				...
				{
					{
						...
						new Matchup
						{
							...
							Team2 = new() { Seed = 16, Name = "High Point/William & Mary" }
						}
					},
					{
						26,
					...
					},
					{
						...
						new Matchup
						{
							...
							Team2 = new() { Seed = 11, Name = "Iowa St/Princeton" }
						}
					},
					{
						30,
